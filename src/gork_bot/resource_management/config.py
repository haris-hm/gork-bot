...
class NewConfig(Config):
    ...
    def get_instructions(self) -> dict[str, str | bool]:
        """
        ...
        options = [
            ...
            self.custom_media_instructions,
        ...
        choice: str = random.choices(options, weights=weights, k=1)[0].strip()
        requires_custom_tags: bool = choice == self.custom_media_instructions

        return {"instructions": choice, "requires_custom_tags": requires_custom_tags}
